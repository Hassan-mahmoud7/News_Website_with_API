                        ...
                        <div class="col-lg-8 m-auto">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><i class="fa-solid fa-user-tie text-primary"></i> Create New
                                        Admin</h1>
                                </div>
                                <form action="{{ route('admin.admins.store') }}" method="POST" class="user">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" name="phone" title="Phone"
                                                ...
                                                id="exampleInputname" aria-describedby="nameHelp"
                                                placeholder="Enter Admin Phone ..." required value="{{ old('phone') }}">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <button class="btn btn-primary rounded-pill m-auto btn-block col-5 "><i class="fa-solid fa-arrow-up"></i> Add New Admin </button>
